...
ScavTrap::ScavTrap():_hitpoint(100),_maxHitpoint(100),_Energy(50),_maxEnergy(50),_level(1),_name("CL4P-TP"),_mDamage(20),_rDamage(15),_armorDamageReduc(3){
...
ScavTrap::ScavTrap(std::string name):_hitpoint(100),_maxHitpoint(100),_Energy(50),_maxEnergy(50),_level(1),_name(name),_mDamage(20),_rDamage(15),_armorDamageReduc(3){
...
int ScavTrap::getmDamage() const {
    return this->_mDamage;
}
int ScavTrap::getrDamage() const {
