...
FragTrap::FragTrap():_hitpoint(100),_maxHitpoint(100),_Energy(100),_maxEnergy(100),_level(1),_name("ClapTrap"),_mDamage(30),_rDamage(20),_armorDamageReduc(5){
...
FragTrap::FragTrap(std::string name):_hitpoint(100),_maxHitpoint(100),_Energy(100),_maxEnergy(100),_level(1),_name(name),_mDamage(30),_rDamage(20),_armorDamageReduc(5){
